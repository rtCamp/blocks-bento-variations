 ...
 *
 * @package blocks-bento-variations-featuers
 */

namespace Blocks_Bento_Variations\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Blocks_Bento_Variations\Features\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( BLOCKS_BENTO_VARIATIONS_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Blocks_Bento_Variations\Features\Inc\Helpers\autoloader' );
